...
to add additional metadata when it is appropriate and feasible.
...
As of DALI-1.2, the \verb|standardID| label is deprecated in favour of \verb|service\_protocol|
as described in the Data Origin note.

Prior versions of DALI did not define the content for \verb|citation| and also recommended
some specific UCD attributes; as of DALI-1.2 this is deprecated in favour of the details in
the Data Origin note.
