...
TABLE element, an INFO element with attribute \texttt{name = "QUERY\_STATUS"}2. The value 
...
element in the RESOURCE with \texttt{name="QUERY\_STATUS"} and the 
...
name="QUERY\_STATUS" and the value="ERROR". If the initial info element (above) 
