...
concreete service specifications should not constrain the names of these resources further.
...
\subsection{WC-DALI-1.1-20160415}
...
\item Expanded section on geomery to allow use of datatype="float" in addition to double.
\item Removed restrictions on the resource name for VOSI-availability resource.
