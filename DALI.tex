...
must fall within [0,60). Valid values are from 0:0:0 (hms) to 24:0:0 (hms) and
-90:0:0 (dms) to 90:0:0 (dms).  Since the upper bound on minutes and seconds is not
part of the valid range; for example 12:34:60 is not allowed and must be expressed
as 12:35:00 instead.
